...
var (
	filter_CarPortService_BillInfo_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_CarPortService_BillInfo_0(ctx context.Context, marshaler runtime.Marshaler, client CarPortServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReqBillInfo
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_CarPortService_BillInfo_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.BillInfo(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_CarPortService_BillInfo_0(ctx context.Context, marshaler runtime.Marshaler, server CarPortServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReqBillInfo
	var metadata runtime.ServerMetadata
	...
	msg, err := server.BillInfo(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterCarPortServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CarPortServiceClient) error {
	...
	mux.Handle("GET", pattern_CarPortService_BillInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CarPortService_BillInfo_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_CarPortService_BillInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"client", "BillInfo"}, "", runtime.AssumeColonVerbOpt(true)))
...
var (
	...
	forward_CarPortService_BillInfo_0 = runtime.ForwardResponseMessage
